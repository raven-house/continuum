...
import { Attester, Fr, computeAttestationHash, signatureToBytes, PublicKey, Attestation } from "./index.js";
...
async function main() {
  ...
  const testSecretKey = Fr.fromString("0x1f0a39723aa40706b947928ec003f9762d06c75ca64c187076fbbd13e1bc493e");
  ...
  const attestation: Attestation = await attester.attest(fields);
  ...
  const pk: PublicKey = attester.publicKey;
